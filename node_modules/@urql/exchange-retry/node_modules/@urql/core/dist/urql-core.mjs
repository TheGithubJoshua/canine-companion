...
import { k as r, s as t, C as n, m as a, a as o, b as s, c, d as u, e as p, f as v, g as d, h as f } from "./urql-core-chunk.mjs";

export { i as stringifyVariables } from "./urql-core-chunk.mjs";

import { toPromise as l, take as h, filter as y, subscribe as k, map as m, tap as x, merge as E, mergeMap as g, takeUntil as O, make as w, onPush as N, share as b, fromPromise as _, fromValue as q, makeSubject as D, lazy as S, onStart as P, switchMap as V, publish as R, takeWhile as A, onEnd as M } from "wonka";
    ...
    for (var v of p.definitions) {
      if (v.kind === e.FRAGMENT_DEFINITION) {
        ...
        if (!a.has(d)) {
          a.set(d, f);
          o.push(v);
        } else if ("production" !== process.env.NODE_ENV && a.get(d) !== f) {
          console.warn("[WARNING: Duplicate Fragment] A fragment with name `" + d + "` already exists in this document.\nWhile fragment names may not be unique across your source, each name must be unique per document.");
        }
      } else {
        o.push(v);
      }
...
var fetchExchange = ({forward: e, dispatchDebug: r}) => t => {
  var n = g((e => {
    ...
    var s = O(y((r => "teardown" === r.kind && r.key === e.key))(t))(v(e, o, i));
    if ("production" !== process.env.NODE_ENV) {
      return N((t => {
...
var C = function Client(e) {
  ...
  function nextOperation(e) {
    var r = t.get(e.key);
    if ("mutation" === e.kind || "teardown" === e.kind || (r ? !r.hasNext : !a.has(e.key))) {
      if ("teardown" === e.kind) {
        a.delete(e.key);
  ...
  var makeResultSource = r => {
    var i = O(y((e => "teardown" === e.kind && e.key === r.key))(s.source))(y((e => e.operation.kind === r.kind && e.operation.key === r.key && (!e.operation.context._instance || e.operation.context._instance === r.context._instance)))(w));
    if ("query" !== r.kind) {
      i = A((e => !!e.hasNext), !0)(i);
    } else {
      i = V((e => {
  ...
  var p = Object.assign(u, {
    ...
    createRequestOperation(e, t, n) {
      ...
      var a;
      if ("production" !== process.env.NODE_ENV && "teardown" !== e && (a = d(t.query)) !== e) {
