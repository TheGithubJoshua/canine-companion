 ...
 */
declare const Card: {
    ({ elevation: cardElevation, onLongPress, delayLongPress, onPress, mode: cardMode, children, style, contentStyle, theme: themeOverrides, testID, accessible, disabled, ...rest }: (OutlinedCardProps | ElevatedCardProps | ContainedCardProps) & Props): JSX.Element;
    Content: {
